...
namespace EasieR.DataAccess.Migrations
{
    ...
    [Migration("20220707154419_add reservation sequence")]
    partial class addreservationsequence
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasieR.Domain.Reservation", b =>
                {
                    ...
                    b.Property<int>("ReservationSequenceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ReservationSequenceId");
            ...
            modelBuilder.Entity("EasieR.Domain.ReservationSequence", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("EasieR.Domain.Reservation", b =>
                {
                    b.HasOne("EasieR.Domain.ReservationSequence", "ReservationSequence")
                        .WithMany()
                        .HasForeignKey("ReservationSequenceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("ReservationSequence");
